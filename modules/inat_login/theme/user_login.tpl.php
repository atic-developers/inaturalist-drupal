...
<div id='user-data'>  
 ...
 <div id='profile'> <a href='<?php print ('user') print $base_url . '/inat/user/'. $login['id'] ?>'> Profile </a>[<a href="<?php print $base_url . '/inat/edit/user/'.'$login["id"]'; ?>" class="edit"><?php print t('Edit'); ?></a>] </div> 
